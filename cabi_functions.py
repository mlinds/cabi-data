    ...
    for filename in filenames:
        ...
        if columns[0] == 'Duration': 
            ...
            try: 
                ...
                raise TypeError(f'Error encountered at {filename}') # with so many files it helps to know which is causing issues
...
def load_stations():
    """
    Loads all the stations and returns a geodataframe of all data about the stations
    """
...
def make_trip_geometry(start_station_num,end_station_num):
