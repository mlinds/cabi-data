...
df = trips.merge(stations, left_on="st", right_on="short_name",).merge(
    stations,
    left_on="en",
    right_on="short_name",
    suffixes=("_st", "_en"),
...
df = df[(df.st == 31247) | (df.en == 31247)]

df = df.assign(logpop=log10(df.popularity))
# %%
...
TOOLTIP_TEXT = {
    "html": "{popularity} trips <br /> Home of commuter in red; work location in green"
}
